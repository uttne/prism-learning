...
namespace Module.ViewModels
{
    public class View2ViewModel:BindableBase
    {
        ...
        public View2ViewModel()
        {
            ...
            // https://github.com/dotnetprojects/WpfToolkit/blob/master/WpfToolkit/Samples/DataVisualisation/SampleDataVM.cs
        ...
        public string SampleText { get; set; } = "Sample text";


        public List<FinancialData> Microsoft
        {
            get
            {
